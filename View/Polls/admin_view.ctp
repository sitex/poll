<ul class="breadcrumb">
	...
	<li class="active"><?php echo __d('polls','Statistics'); ?></li>
</ul>
...
<table class="table">
	<thead>
		<tr>
			<td>
				<strong><?php echo __d('polls','Answer');?></strong>
			</td>
			 <td class="span3" style='text-align:center'>
				<strong><?php echo __d('polls','Vote Count').' ('. $totalVote.')';?></strong>
			</td>
			<td class="span4" style='text-align:center'>
				<strong><?php echo __d('polls','Percent');?></strong>
			</td>
		</tr>
	</thead>
	<tbody>
